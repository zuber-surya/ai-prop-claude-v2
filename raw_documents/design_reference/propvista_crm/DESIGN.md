...
- **Primary (#003d9b):** Used for core system actions, primary buttons, and navigational links. It represents the "human" agency within the CRM.
...
- **Buttons:** 
  - *Primary:* Solid #003d9b with white text. 
...
- **Input Fields:** 8px radius, #E5E5EA border. On focus, use a 2px #003d9b border.

...
4. **Primary blue shade reconciliation** (`UI_REFERENCE.md` §6) — `#003d9b` vs `#003d9b` — pick one before `tailwind.config.js` is written. Small, non-blocking for docs; resolve during Phase 1/2 setup.

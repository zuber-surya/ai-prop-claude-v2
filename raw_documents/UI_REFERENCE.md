...
|---|---|---|
| Colors | `DESIGN.md` front-matter `colors:` block | Primary `#003d9b` for core actions; Secondary `#8E44AD`/`#873da6` reserved **only** for AI-driven elements (match scores, chat widget, AI action buttons) — never for standard UI, per DESIGN.md's own rule |
